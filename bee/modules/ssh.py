...
class HoneyPotSSHUserAuthServer(userauth.SSHUserAuthServer):
    def serviceStarted(self):
        ...
        logtype = self.transport.factory.beeservice.logger.LOG_SSH_REMOTE_VERSION_SENT
        log = self.transport.factory.beeservice.log
        log(logdata,
            logtype=logtype,
    ...
    def auth_password(self, packet):
        ...
        logtype = self.transport.factory.beeservice.logger.LOG_SSH_LOGIN_ATTEMPT
...
class HoneyPotTransport(transport.SSHServerTransport):
    ...
    def connectionMade(self):
        ...
        logtype = self.factory.beeservice.logger.LOG_SSH_NEW_CONNECTION
...
class BeeSSH(BeeService):
    ...
    def getService(self):
        ...
        factory.portal.registerChecker(BeePublicKeyChecker(logger=factory.logger))
